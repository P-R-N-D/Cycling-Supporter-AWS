...
public class SpeedLayout extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.speed_layout, container, false);
    ...
    protected void getParameter() throws SecurityException{
        ...
        textviewSpeed=v.findViewById(R.id.speed_layout_textview_speed);
        textviewLatitude=v.findViewById(R.id.speed_layout_textview_latitude);
        textviewLongitude=v.findViewById(R.id.speed_layout_textview_longitude);
        textviewAltitude=v.findViewById(R.id.speed_layout_textview_altitude);
        textviewBearing=v.findViewById(R.id.speed_layout_textview_bearing);

        textviewWeather=v.findViewById(R.id.speed_layout_textview_weather);
        textviewTemperature=v.findViewById(R.id.speed_layout_textview_temperature);

        linearlayoutTmap=v.findViewById(R.id.speed_layout_linearlayout_tmap);
        setTmap();

        buttonReset=v.findViewById(R.id.speed_layout_button_resetTmapView);

        buttonSendLocation=v.findViewById(R.id.speed_layout_button_sendLocation);
